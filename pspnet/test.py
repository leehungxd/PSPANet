...
def main():
    ...
    parser.add_argument('--work_dir', default='jobs',
    ...
    parser.add_argument('--image_list', required=True, default='/home/lihang/data/train_data/bdd100k/seg/valSeg11.txt',
                        help='List of images to test on. This is required '
                             'for context module to deal with variable image '
                             'size.')
    parser.add_argument('--weights', required=True, default='jobs/bdd100k/pspnet50/snapshots/pspnet50_iter_2000.caffemodel')
