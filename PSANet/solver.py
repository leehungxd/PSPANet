...
weights = '/home/lihang/projects/PSPNet/pspnet/jobs/cityscape/pspnet50/snapshots/pspnet50_cityscape_iter_77350.caffemodel'
...
for _ in range(100):
    ...
    score.seg_tests(solver, False, test, layer='conv6_zoom')
